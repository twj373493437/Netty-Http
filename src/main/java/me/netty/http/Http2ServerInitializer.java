...
import me.netty.http.handler.Http1Handler;
import me.netty.http.handler.HelloWorldHttp2Handler;
import me.netty.http.handler.Http2OrHttpHandler;
...
/**
 * Sets up the Netty pipeline for the example http2Orhttp. Depending on the endpoint config, sets up the
